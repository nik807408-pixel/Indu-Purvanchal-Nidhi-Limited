...
// ─────────────────────────────────────────────────────────
const SUPABASE_URL = 'https://uqlyonilofzacsisdbgx.supabase.co';
const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVxbHlvbmlsb2Z6YWNzaXNkYmd4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODEyMzAzMjYsImV4cCI6MjA5NjgwNjMyNn0.ZbBznVYAmPawVoftepT1EpF73PzwNxELbK4MK3HTlpI';
// ─────────────────────────────────────────────────────────
...
// ── DEMO MODE — DISABLED in production (Indu Purvanchal Nidhi) ────────
...
function sendOTPviaSMS() {
  ...
  // SMS message
  const msg = 'Indu Purvanchal Nidhi Limited OTP: ' + generatedOTP + ' (10 min valid). किसी को share न करें।';
...
` +
    `इन्दु पूर्वांचल निधि लि. में आपका OTP है:
...
function buildMonthlyReportHTML(month) {
  ...
  <div style="background:white;border-radius:12px;padding:12px;margin-bottom:12px;text-align:center;box-shadow:0 2px 8px rgba(15,37,71,.08)">
    <div style="font-size:16px;font-weight:800;color:var(--navy)">इन्दु पूर्वांचल निधि लि. — Monthly Report</div>
  ...
  <div id="cashbook-wrap">
    ...
    <div id="cashbook-print-area" style="background:white;border-radius:12px;padding:14px;box-shadow:0 2px 8px rgba(15,37,71,.08)">
      <div style="text-align:center;font-size:16px;font-weight:800;color:var(--navy);border-bottom:2px solid var(--navy);padding-bottom:6px;margin-bottom:10px">
        इन्दु पूर्वांचल निधि लि. — Cash Book / नकद बही
      </div>
...
<!-- Header -->
<div class="header">
  <div class="company-name">इन्दु पूर्वांचल निधि लि.</div>
...
<div class="footer-text">
  किसी भी शिकायत के लिए संपर्क करें | For any complaint please contact: <strong>Indu Purvanchal Nidhi Limited</strong>
</div>
...
function renderMeetingTab() {
  ...
  daysToShow.forEach(day => {
    ...
    html += '<div style="font-size:16px;font-weight:700;text-transform:uppercase">इन्दु पूर्वांचल निधि लि.</div>';
...
async function downloadClientPDF(clientId) {
  ...
  const printContent = `
    ...
    <body>
      <h1>🚩 Indu Purvanchal Nidhi Limited — Client Report</h1>
  ...
  days.forEach(day => {
    ...
    <div class="page">
      <div style="text-align:center;border-bottom:2px solid #000;padding-bottom:6px;margin-bottom:6px">
        <div style="font-size:16px;font-weight:bold">इन्दु पूर्वांचल निधि लि.</div>
...
<head>
<meta charset="UTF-8"/>
<title>CDS - Indu Purvanchal Nidhi Limited</title>
<style>
        ...
        <div style="margin-bottom:20px" id="cds-${day.replace(/\s/g,'-')}">
          ...
          <div style="background:white;border-radius:14px;padding:14px;margin-bottom:2px;box-shadow:0 2px 8px rgba(15,37,71,.07);${isToday?'border:2px solid var(--gold)':'border:1px solid var(--border)'}">
            ...
            <div style="text-align:center;border-bottom:2px solid var(--navy);padding-bottom:8px;margin-bottom:10px">
              <div style="font-size:15px;font-weight:700;color:var(--navy)">इन्दु पूर्वांचल निधि लि.</div>
